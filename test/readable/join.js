...
describe('join', function () {
  ...
  describe('constants in join conditions', function () {
    ...
    it('supports non-equality operations between join columns', function () {
      return db.alpha.join({
        beta: {
          type: 'INNER',
          on: {
  ...
  it('joins to a self-joining table', function () {
    return db.selfjoin.join({
      sj: {
        relation: 'selfjoin',
        decomposeTo: 'object'
      }
  ...
  it('joins to a self-joining table, from another', function () {
    return db.beta.join({
      sj1: {
        relation: 'selfjoin',
        on: {
