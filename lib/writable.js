...
const Writable = function (spec) {
  ...
  this.pk = spec.pk ? _.castArray(spec.pk) : undefined;
  this.fks = spec.fks || undefined;
 ...
 * DO UPDATE, look into the {@link https://massivejs.org/docs/options-objects|onConflictUpdate option}.
 *
...
Writable.prototype.updateDoc = function (criteria, changes, options = {}) {
  ...
  const queryCriteria = where(this, criteria, 1, options.generator || (options.document ? 'docGenerator' : 'tableGenerator'));
